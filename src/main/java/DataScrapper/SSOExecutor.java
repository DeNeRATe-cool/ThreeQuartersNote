...
public class SSOExecutor {
    ...
    private ClassListExecutor classListExecutor;
...
//        options.addArguments("--headless");
     ...
     */
    public boolean targetCourseTimeTable(String timeTable) throws InterruptedException {
    ...
    public List<String> getCourseList() {
        classListExecutor = new ClassListExecutor(driver, wait);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ssoExecutor.searchCourse(course);
        ssoExecutor.gotoTargetCourse(teacher);
        ssoExecutor.targetCourseTimeTable(timeTable);
        ssoExecutor.downloadCourseVideo();
    }
}
